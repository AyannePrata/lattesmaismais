                    ...
                    <div className='Validation'>
                        ...
                        <div className='TablesDiv'>
                            <div className='overFlow-y'>
                                <CurriculumTableRS curriculumns={this.state.curriculumList} className="CurrTable" id="curricTable01" />
                            </div>
                            <div className='overFlow-y'>
                                <ValidatorTableRS validators={this.state.validatorList} className="ValidatorTable" id="validtb01" />
                            </div>
                            <div className='DateAndHour'>
                                <label htmlFor='date01'>Selecione a data: <input type='date' id='date01' /> </label>
                                <br/>
                                <br/>
                                <label htmlFor='hour01'>Selecione o horário: <input type='time' id='hour01' /> </label>
                            </div>
                        </div>
                    </div>
                </div>
